        ...
        <CardContent className="grid p-0 md:grid-cols-2">
          ...
          <div className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 dark:from-zinc-950 dark:via-blue-950/20 dark:to-purple-950/20 relative hidden md:block overflow-hidden">
            <div className="absolute inset-0 overflow-hidden">
              <div className="absolute -left-20 -top-20 h-64 w-64 animate-pulse rounded-full bg-gradient-to-br from-blue-400/30 to-cyan-400/30 blur-3xl" />
              <div className="absolute -right-20 top-1/3 h-64 w-64 animate-pulse rounded-full bg-gradient-to-br from-purple-400/30 to-pink-400/30 blur-3xl" style={{ animationDelay: "1s" }} />
              <div className="absolute bottom-0 left-1/3 h-64 w-64 animate-pulse rounded-full bg-gradient-to-br from-indigo-400/30 to-blue-400/30 blur-3xl" style={{ animationDelay: "2s" }} />
            </div>
